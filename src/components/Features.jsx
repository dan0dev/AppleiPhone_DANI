			...
			<div className="screen-max-width">
				...
				<div className="flex flex-col justify-center items-center overflow-hidden">
					...
					<div className="flex-center flex-col sm:px-10">
						<div className="relative h-[50vh] w-full flex items-center rounded-lg">
							<video
								playsInline
								id="exploreVideo"
						...
						<div className="flex flex-col w-full relative">
							<div className="feature-video-container">
								<div className="overflow-hidden flex-1 h-[50vh] rounded-[10px]">
							...
							<div className="feature-text-container mt-12">
								<div className="flex-1 flex-center">
									<p className="feature-text g_text text-center lg:text-left">
										iPhone 15 Pro is{' '}
								...
								<div className="flex-1 flex-center mt-6">
									<p className="feature-text g_text text-center lg:text-left">
